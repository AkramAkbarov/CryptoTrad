...
class HaberFragment : Fragment() {
    ...
    private val languages = listOf(
        ...
        Language(
            "Son Zamanların Yıldızı: ERC\n404 Coinleri 'Sıradaki Büyük\nŞey' mi? ",
            "kriptokoin: 17 saat once",
        ...
        Language(
            "Kaynaklar, ABD'de 110\n" +
                    "Milyon Kişinin Izlediği Super\nBowl Etkinliğinde Bitcoin Spot..",
            "bitcoinsistemi: 17 saat once",
        ...
        Language(
            "JPMorgan ve iki analistten\n" +
                    "Ethereum'un Spot ETF\nAçiklamasi!",
            "coinmuhendisi: 21 saat once",
        ...
        Language(
            "Yarın, 0 16 Altcoin iİçin Kritik:\nİşte Olacakların Listesi!",
        ...
        Language(
            "Bitcoin'in ani\n" +
                    ...
                    "Doları Yok Etti! ",
            "CoinMuhendisi • 1 gun once ",
            "https://coinmuhendisi.com/blog/bitcoinin-ani-hareketleri-661-milyon-dolari-yok-etti/?utm_source=coingecko&utm_content=coingecko&utm_campaign=coingecko&utm_medium=coingecko&utm_term=coingecko",
